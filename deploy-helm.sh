...
# Create namespace
sudo kubectl create namespace credential-showcase-ns --dry-run=client -o yaml | sudo kubectl apply -f -
sudo kubectl create namespace showcase-ui-ns --dry-run=client -o yaml | sudo kubectl apply -f -

# Create secrets with credentials
sudo kubectl create secret generic credential-showcase \
...
sudo kubectl create secret generic showcase-ui \
    -n showcase-ui-ns \
